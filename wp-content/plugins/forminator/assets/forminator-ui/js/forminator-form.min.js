...
function _typeof(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.inputStates = function(o) {
        var e = t(o),
            i = e.closest("form");
        if (e.is("input") || i.is(".forminator-poll") && (i.is(".forminator-ui") || i.is(".forminator-custom-form"))) return e.each(function() {
            var o, e;
            o = t(this), e = o.closest(".forminator-field"), o.mouseover(function(t) {
                ...
                function(o) {
                    var e = t(o),
                        i = e.closest(".forminator-field");
                    "" !== e.val().trim() && i.addClass("forminator-is_filled"), e.on("change", function() {
                        "" !== e.val().trim() ? i.addClass("forminator-is_filled") : i.removeClass("forminator-is_filled")
                    })
                }(this)
        }), this
    }
...
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.textareaStates = function(o) {
        var e = t(o),
            i = e.closest("form");
        if (e.is("textarea") || i.is(".forminator-ui") || i.is(".forminator-custom-form")) return e.each(function() {
            var o, e;
            o = t(this), e = o.closest(".forminator-field"), o.mouseover(function(t) {
                    e.addClass("forminator-is_hover"), t.stopPropagation()
                }).mouseout(function(t) {
...
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.textareaMaterial = function(o) {
        var e = t(o),
            ...
            n = i.find(".forminator-label"),
            r = e.closest("form");
        if ((e.is("textarea") || r.is(".forminator-ui") || r.is(".forminator-custom-form")) && !e.hasClass("wp-editor-area")) return function() {
            if (e.parent().hasClass("forminator-textarea--wrap") || e.wrap('<div class="forminator-textarea--wrap"></div>'), n.length) {
                var t = (0 === n.height() ? 20 : n.height()) + 9;
                n.addClass("forminator-floating--textarea"), i.css({
                    position: "relative"
                }), i.hasClass("forminator-is_filled") && i.hasClass("forminator-is_active") || n.css({
                    "padding-top": t + "px"
                }), e.css({
                    "padding-top": t + "px"
                })
...
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.radioStates = function(o) {
        var e = t(o),
            i = e.find("input");
        if (e.is("label") && "radio" === i.prop("type")) return i.each(function() {
            t(this).on("click", function() {
                var o = t(this),
                    e = o.parent(),
                    i = e.closest(".forminator-field").find(".forminator-radio");
                i.find("input").prop("checked", !1), i.removeClass("forminator-is_checked"), o.prop("checked", "checked"), e.addClass("forminator-is_checked")
            })
        }), this
    }
}(jQuery),
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.checkboxStates = function(o) {
        var e = t(o),
            i = e.find("input");
        if (e.is("label") && "checkbox" === i.prop("type")) return i.each(function() {
            t(this).on("click", function() {
                var o = t(this).parent();
                o.is(".forminator-is_checked") ? o.removeClass("forminator-is_checked") : o.addClass("forminator-is_checked")
            })
        }), this
    }
}(jQuery),
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.multiSelectStates = function(o) {
        var e = t(o),
            ...
            n = i.find("input");
        if (e.is(".forminator-multiselect") && 0 !== i.length) return n.each(function() {
            t(this).on("click", function() {
                var o = t(this).parent();
                o.is(".forminator-is_checked") ? o.removeClass("forminator-is_checked") : o.addClass("forminator-is_checked")
            })
        ...
        t(".forminator-custom-form").each(function() {
            ...
            t.each(["bold", "flat", "default", "material", "none"], function(n, r) {
                var s, a = "en",
                    c = "Search",
                    l = -1;
                o.hasClass("forminator-design--" + r) && i.length && i.each(function() {
                    var o = t(this),
                        i = o.closest(".sui-dialog-content"),
                        n = i.length ? i : o.closest(".elementor-popup-modal");
                    s = !0 === o.data("rtl-support") ? "rtl" : "ltr", c = "" !== o.data("placeholder") ? o.data("placeholder") : "Search", a = "" !== o.data("language") ? o.data("language") : "en", l = !0 === o.data("search") ? 0 : -1, n.length || (n = t(document.body)), o.FUIselect2({
                        dir: s,
                        language: a,
                        placeholder: c,
                        dropdownCssClass: "forminator-custom-form-" + e + " forminator-dropdown--" + r,
                        minimumResultsForSearch: l,
                        dropdownParent: n
                    }).on("select2:opening", function() {
                        o.data("select2").$dropdown.find(":input.select2-search__field").prop("placeholder", "" !== o.data("placeholder") ? o.data("placeholder") : "Search"), (o.closest(".hustle-popup").length || o.closest(".hustle-slidein")) && t(document.body).addClass("forminator-hustle-dropdown-fix")
...
function() {
    ...
    t.KeyCode = {
        ...
        t.dispatchEvent(o)
    }, t.Utils.IgnoreUtilFocusChanges = !1, t.Utils.dialogOpenClass = "forminator-authentication-enabled", t.Utils.focusFirstDescendant = function(o) {
